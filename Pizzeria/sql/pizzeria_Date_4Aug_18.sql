...
INSERT INTO `orders` VALUES (1,'ORDER-OLIVES',1),(2,'ORDER-RED_PEPPER',2),(3,'ORDER-PANEER',1),(4,'ORDER-PANEER',2),(5,'ORDER-OLIVES',1),(6,'ORDER-OLIVES',2),(7,'ORDER-RED_PEPPER',2),(8,'ORDER-PANEER',1),(9,'ORDER-PANEER',1);
...
CREATE TABLE `pizza` (
  ...
  PRIMARY KEY (`pid`),
  KEY `FK4afsi5ial6n44mgugd4q98csm` (`order_id`),
  CONSTRAINT `FK4afsi5ial6n44mgugd4q98csm` FOREIGN KEY (`order_id`) REFERENCES `orders` (`orderId`)
...
INSERT INTO `pizza` VALUES (1,'Peppy Panner','INDIAN',NULL),(2,'Chezwan','ITALIAN',NULL);
...
CREATE TABLE `pizza_crust` (
  ...
  CONSTRAINT `FKmbmm1bv5ys15cwrhn306r1nbb` FOREIGN KEY (`piz_id`) REFERENCES `pizza` (`pid`)
...
-- Dump completed on 2018-08-04 13:13:47
